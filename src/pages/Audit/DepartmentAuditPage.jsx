...
const HIDDEN_KEYS = new Set(["auditId", "departmentId", "deptId", "id"]);
...
function DepartmentAuditPage() {
    ...
    async function fetchAudit() {
        ...
        setError(null);
        try {
            const response = await api.get("/department/audit", {
                params: { page, size: PAGE_SIZE }
            });

            console.log("Department Audit API response:", response.data);
            ...
            console.error("Department Audit API error:", err);
            setError("Failed to load department audit records. Please try again.");
        } finally {
            setLoading(false);
        }
    }
                            ...
                            <TableRow>
                                <TableCell colSpan={4} align="center" sx={{ py: 8 }}>
                                    ...
                                    <Typography variant="body2" color="text.disabled">
                                        Department changes will appear here.
                                    </Typography>
                                </TableCell>
                            </TableRow>
                        ) : (
...
export default DepartmentAuditPage;
